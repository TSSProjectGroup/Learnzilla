...
public partial class JavaQuiz1 : System.Web.UI.Page
{
    int count = 0;
    ...
    protected void SubmitQuiz_Click1(object sender, ImageClickEventArgs e)
    {
        Result.Text = "You Scored:";
        Score.Text = (count).ToString();
        ShowAns1.Text = "-32768 to 32767";
        ShowAns2.Text = " int";
        ShowAns3.Text = "-3.4e+038";
        ShowAns4.Text = "-128 to 127";
        ShowAns5.Text = "double";
    }
}